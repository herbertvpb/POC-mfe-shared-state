...
var TopNumber = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_core2.Paper, {
    shadow: "sm",
    radius: "md",
    p: "md",
    m: "10",
    withBorder: true,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_core2.Title, {
        children: "Top Number!!!"
      }),
      playing && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_core2.Button, {
        mt: "md",
        variant: "outline",
        color: "violet",
        size: "xl",
      ...
      !playing && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_core2.Button, {
        mt: "md",
        size: "xl",
        fullWidth: true,
        onClick: () => {
